                 ...
                 int nrhs, const mxArray *prhs[]) 
{
    ...
    func = (lsl_get_source_id_t)(*pTmp);  // Correct dereference for function pointer
    
    /* get additional inputs */
    info = *(uintptr_t *)mxGetData(prhs[1]);
    
    /* invoke & return */
    source_id = func((streaminfo)info);  // Ensure correct casting to streaminfo
    
    /* create output */
    plhs[0] = mxCreateString(source_id);  // Create a string output
}
