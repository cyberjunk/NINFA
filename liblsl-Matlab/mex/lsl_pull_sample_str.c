...
/* function [SampleData,Timestamp] = lsl_pull_sample_str(LibHandle,Inlet,NumChannels,Timeout) */
		  ...
		  int nrhs, const mxArray*prhs[] ) 
{
    ...
    /* get function handle */
    field = mxGetField(prhs[0],0,"lsl_pull_sample_str");
    if (!field)
